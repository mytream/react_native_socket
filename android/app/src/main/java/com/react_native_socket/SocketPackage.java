 ...
 */
public class SocketPackage extends ReactContextBaseJavaModule {

    private Socket mSocket;


    public SocketPackage(ReactApplicationContext reactContext){
    ...
    public void initialise(String host,ReadableMap config){
        ...
        try {
            ...
            Log.d("SocketIoModule","初始化socket错误,详细信息:",e);
        }
